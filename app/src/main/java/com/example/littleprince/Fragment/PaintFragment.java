...
import com.example.littleprince.adapter.ColorListAdapter;
import com.example.littleprince.task.StickerTask;
import com.example.littleprince.ui.ColorPicker;
import com.example.littleprince.Views.CustomPaintView;
import com.example.littleprince.Views.PaintModeView;
...
public class PaintFragment extends BaseEditFragment implements View.OnClickListener, ColorListAdapter.IColorListAction {
    ...
    private void updateEraserView() {
        mEraserView.setImageResource(isEraser ? R.mipmap.eraser_seleced : R.mipmap.eraser_normal);
